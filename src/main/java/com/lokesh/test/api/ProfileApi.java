...
public interface ProfileApi {
  ...
  @ApiOperation(
    value = "create user",
    response = SuccessfulResponse.class,
    authorizations = {
      @Authorization(
        value = "profile_auth",
        scopes = {
  ...
  ResponseEntity<SuccessfulResponse> addUser(
  ...
  @ApiOperation(
    ...
    authorizations = {
      @Authorization(
        value = "profile_auth",
        scopes = {@AuthorizationScope(scope = "write:profile", description = "delete user profile")}
      )
    },
    tags = {
      "Profile",
  ...
  @ApiOperation(
    value = "read user profile",
    response = Profile.class,
    authorizations = {
      @Authorization(
        value = "profile_auth",
        scopes = {@AuthorizationScope(scope = "read:profile", description = "read user profile")}
      )
    },
    tags = {
      "Profile",
  ...
  ResponseEntity<Profile> getUserProfile(
      @ApiParam(value = "", required = true) @PathVariable("id") Long id);

  @ApiOperation(
    value = "Modify user profile",
    authorizations = {
      @Authorization(
        value = "profile_auth",
        scopes = {@AuthorizationScope(scope = "write:profile", description = "modify user profile")}
      )
    },
    tags = {"Profile"}
  )
  ...
  ResponseEntity<Void> updateProfile(
      @ApiParam(value = "", required = true) @PathVariable("id") Long id,
      @ApiParam(value = "", required = true) @Valid @RequestBody Profile body);
}
